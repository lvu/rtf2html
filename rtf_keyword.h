...
class rtf_keyword{
 public:
   enum keyword_type {rkw_unknown,
                      rkw_b, rkw_bin, rkw_brdrnone, rkw_bullet,
                      rkw_cell, rkw_cellx, rkw_clbrdrb, rkw_clbrdrl, 
                      ...
                      rkw_margl, 
                      rkw_paperw, rkw_par, rkw_pard, rkw_plain, 
                      rkw_qc, rkw_qj, rkw_ql, rkw_qmspace, rkw_qr, 
                      rkw_rdblquote, rkw_ri, rkw_row, rkw_rquote,
